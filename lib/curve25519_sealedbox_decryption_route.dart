...
class Curve25519SealedBoxDecryptionRoute extends StatefulWidget {
  const Curve25519SealedBoxDecryptionRoute({Key? key}) : super(key: key);

  final String title = 'SealedBox Entschlüsselung';

  @override
  _MyFormPageState createState() => _MyFormPageState();
}

class _MyFormPageState extends State<Curve25519SealedBoxDecryptionRoute> {
  @override
  void initState() {
    super.initState();
  ...
  String txtDescription =
      'SealedBox Entschlüsselung.'
      ' Alle Schlüssel sind Base64 encoded.'
      ' Zur Entschlüsselung wird der eigene Private key (Empfänger) benötigt.';
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          if (_formKey.currentState!.validate()) {
                            ...
                            if (algorithm != 'Curve25519 SealedBox') {
                              outputController.text =
                                  'Fehler: es handelt sich nicht um einen Datensatz, der mit Curve25519 SealedBox verschlüsselt worden ist.';
                              return;
                            }
                            ...
                            try {
                              ...
                              final unsealedBox = SealedBox(privateKey);
                              decryptedtext = unsealedBox.decrypt(ciphertext);
